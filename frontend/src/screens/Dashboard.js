    ...
    <Layout>
      ...
      <div className="w-full grid xl:grid-cols-4 gap-6 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
        {dashboardCards.map((card) => (
          <div
            key={card.id}
            className="bg-white rounded-xl border border-gray-300 p-5 shadow-md"
          >
            <div className="flex gap-4 items-center">
              ...
              <h2 className="text-sm font-medium text-gray-800">{card.title}</h2>
            </div>
            <div className="grid grid-cols-8 gap-4 mt-4 bg-gray-100 py-5 px-8 items-center rounded-xl">
      ...
      <div className="w-full my-6 grid xl:grid-cols-8 grid-cols-1 gap-6">
        <div className="xl:col-span-6 w-full">
          <div className="bg-white rounded-xl border border-gray-300 p-5 shadow-md">
            <div className="flex justify-between gap-2">
              <h2 className="text-sm font-medium">Earning Reports</h2>
              <p className="flex gap-4 text-sm items-center">
                5.44%{' '}
                <span className="py-1 px-2 bg-teal-500 text-white text-xs rounded-xl">
                  +2.4%
                </span>
              </p>
            </div>
          ...
          {/* transaction */}
          <div className="mt-6 bg-white rounded-xl border border-gray-300 p-5 shadow-md">
            <div className="flex justify-between gap-2">
        ...
        >
          ...
          <div className="bg-white rounded-xl border border-gray-300 p-5 shadow-md">
            ...
            {memberData.slice(3, 8).map((member, index) => (
              <Link
                ...
                key={index}
                className="flex justify-between gap-4 mt-6 border-b pb-4 border-gray-300"
              >
                <div className="flex gap-4 items-center">
                  <img
                    src={member.image}
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="text-xs font-medium text-gray-800">{member.title}</h3>
          ...
          {/* today appointments */}
          <div className="bg-white rounded-xl border border-gray-300 p-5 xl:mt-6 shadow-md">
